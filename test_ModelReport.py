...
class Test_ModelReport(unittest.TestCase):
    def test_CreateReport(self):
        ...
        refrences = {'Wikipedia':"https://en.wikipedia.org/wiki/Naive_Bayes_classifier","Scikit-learn":"https://scikit-learn.org/stable/modules/naive_bayes.html"}
        ...
        myModelReport = ModelReport(modelName,modelCreator,mlPrinciple,refrences,algorithemDescription,graphicPath,graphicDescription)
